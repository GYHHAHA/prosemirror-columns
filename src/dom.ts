...
export function handleMouseDown(
  ...
  const finish = (e: MouseEvent) => {
    ...
    updateColumnNodeWidth(view, pluginState.activeHandle, finalWidth);
    view.dispatch(
      view.state.tr.setMeta(gridResizingPluginKey, {
        setDragging: null,
      }),
  ...
  const move = (e: MouseEvent) => {
    ...
    displayColumnWidth(view, pluginState.activeHandle, newWidth);
  };

  win.addEventListener('mouseup', finish);
  win.addEventListener('mousemove', move);

  displayColumnWidth(view, pluginState.activeHandle, domWidth);
